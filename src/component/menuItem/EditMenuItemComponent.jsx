...
class EditMenuItemComponent extends Component {
    ...
    constructor(props){
        ...
        this.loadMenuItem = this.loadMenuItem.bind(this);
    ...
    loadMenuItem() {
        MenuItemApiService.fetchMenuItemById(window.localStorage.getItem("menuItemId"))
            .then((res) => {
                ...
                ingredientsId: menuItem.ingredients.map(ingredients => ingredients.id).reduce((prev,curr) => prev + "," + curr),
                })
